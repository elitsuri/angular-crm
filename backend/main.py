"""
Angular CRM - Backend API
Angular CRM application with contacts, deals pipeline, and email integration
"""
...
app = FastAPI(
    title="Angular CRM",
    description="Angular CRM application with contacts, deals pipeline, and email integration",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "Angular CRM"}
